...
- Compararon pares de tipos de letra (véase el [Capítulo 4: Comparaciones de pares]({% link _chapters_es/4-que-y-como-se-mide.md %}#paired-comparisons)) e identificaron la que percibían como más legible 
...
- identificar dimensiones, [constructos]({% link pages/glossary_en.md %}#construct) o variables utilizadas para generar juicios 
